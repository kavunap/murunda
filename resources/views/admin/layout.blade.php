...
<html lang="en">
  <head>
    ...
    <title>Murunda admin dashboard</title>

    <meta name="description" content="Murunda hospital, Murunda HD Hopitale de district, Rutsiro district hospital">
    <meta name="author" content="Murunda hospital">
    <meta name="robots" content="Murunda hospital">

    <!-- Open Graph Meta -->
    <meta property="og:title" content="Murunda hospital">
    <meta property="og:site_name" content="Murunda rutsiro district hospital">
    <meta property="og:description" content="Murunda hospital, Murunda HD Hopitale de district, Rutsiro district hospital">
    <meta property="og:type" content="website">
    <meta property="og:url" content="">
    <meta property="og:image" content="Murunda Hospital">

    <!-- Icons -->
    <!-- The following icons can be replaced with your own, they are used by desktop and mobile browsers -->
    <link rel="shortcut icon" href="{{ asset('web/images/murundalogo.jpg') }}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('web/images/murundalogo.jpg') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('web/images/murundalogo.jpg') }}">
    <!-- END Icons -->
    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
          ...
          <div class="bg-primary-op">
            <div class="content-header">
              ...
              <a class="img-link me-1" href="be_pages_generic_profile.html">
                <img class="img-avatar img-avatar48" src="{{ asset('assets/media/avatars/avatar10.jpg') }}" alt="hendukirwa muri byose">
              </a>
              <!-- END User Avatar -->
      ...
      <nav id="sidebar" aria-label="Main Navigation">
          ...
          <div class="content-header bg-white-5">
            ...
            <a class="fw-semibold text-white tracking-wide" href="/">
              <span class="smini-hidden">
                Murunda<span class="opacity-75">Hospital</span>
              </span>
            </a>
            <!-- END Logo -->
        ...
        <div class="js-sidebar-scroll">
          ...
          <div class="content-side">
            <ul class="nav-main">
              @if(auth()->user() && auth()->user()->user_role =="admin" || auth()->user() && auth()->user()->user_role =="hr")
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="/departments">
                  ...
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="/subs">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="/services/create">
                  ...
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="/departments/create">
                      <span class="nav-main-link-name">Department</span>
                    </a>
                  </li>
                </ul>
              </li>
              @elseif(auth()->user() && auth()->user()->user_role =="user")
              <li class="nav-main-item">
                <li class="nav-main-item">
                  <a class="nav-main-link active" href="/admin">
                    <i class="nav-main-link-icon fa fa-location-arrow"></i>
      ...
      <header id="page-header">
        ...
        <div id="page-header-search" class="overlay-header bg-header-dark">
          <div class="bg-white-10">
            <div class="content-header">
              {{-- <form class="w-100" action="{{ route('search') }}" method="POST" > --}}
              <form class="w-100" action="#" method="POST" >
                @csrf
                <div class="input-group">
                  <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
                  <button type="submit" class="btn btn-alt-primary" data-toggle="layout" data-action="">
                    <i class="fa fa-fw fa-times-circle"></i>
                  </button>
                  <input type="text" class="form-control border-0" placeholder="Search or hit ESC.." id="page-header-search-input" name="search">
                </div>
              </form>
            </div>
          </div>
        ...
        <div class="content py-0">
          <div class="row fs-sm">
            <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-end">
              Crafted with <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" href="" target="_blank">Murunda hospital IT Department</a>
            </div>
            <div class="col-sm-6 order-sm-1 text-center text-sm-start">
              <a class="fw-semibold" href="" target="_blank">Murunda Hospital</a> &copy; <span data-toggle="year-copy"></span>
            </div>
          </div>
        </div>
      </footer>
